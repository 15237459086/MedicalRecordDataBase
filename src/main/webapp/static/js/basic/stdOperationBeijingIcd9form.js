	            	...
	            	if (data.success==true) {
	            		...
	            		if(code!=null &&　code!=""){
	            			   ...
	            			   var querycode = $("#querycode").val();
	                 		   location.href = path+"/operationIcd9/getStdOperationIcd9s?currentPage="+currentPageCount+"&pageSize="+pageCount
	                 		   +"&name="+queryName+"&code="+querycode+"&indexCode="+indexCode;
	            		}else{
	              		   location.href = path+"/operationIcd9/getStdOperationIcd9s";
	            		}
	    			} else {
