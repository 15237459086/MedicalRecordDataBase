	            	...
	            	if (data.success==true) {
	            		...
	            		if(code!=null &&　code!=""){
	            			   ...
	            			   var querycode = $("#querycode").val();
	                 		   location.href = path+"/diagnosis/getDiagnosisRc020Icd10s?currentPage="+currentPageCount+"&pageSize="+pageCount
	                 		   +"&name="+queryName+"&code="+querycode+"&indexCode="+indexCode;
	            		}else{
	              		   location.href = path+"/diagnosis/getDiagnosisRc020Icd10s";
	            		}
	    			} else {
