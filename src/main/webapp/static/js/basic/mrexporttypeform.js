		            	...
		            	if (data.success==true) {
		            		if(basicId!=null &&　basicId!=""){
		            			   ...
		            			   var hospitalId = $("#queryHospitalId").val();
		                 		   location.href = path+"/exportType/getMrPrinterTypes?currentPage="+currentPageCount+"&pageSize="+pageCount+"&name="+queryName+"&hospitalId="+hospitalId;
		            		}else{
		              		   location.href = path+"/exportType/getMrPrinterTypes";
		            		}
		    			} else {
