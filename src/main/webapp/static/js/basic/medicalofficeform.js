	            	...
	            	if (data.success==true) {
	            		if($("#basicId").val()!=null &&　$("#basicId").val()!=""){
	            			   ...
	            			   var hospitalId = $("#queryHospitalId").val();
	                 		   location.href = path+"/basic/getMedicalOffices?currentPage="+currentPageCount+"&pageSize="+pageCount+"&name="+queryName+"&hospitalId="+hospitalId;
	            		}else{
	              		   location.href = path+"/basic/getMedicalOffices";
	            		}
	    			} else {
