	...
	<div style="width:100%;height:80%;">
			...
			<div style="width:100%;height:510px;">
				<div id="list_NR" style="float:left">
					...
					<form class="form-horizontal" action="${path}/exportType/insertMrPrinterType" method="post" style="width:100%">
						...
						<table style="width:100%;margin-top:5px;text-align: center">
							...
							<td>标签类型:</td>
								<td class="tdLable2">
								<div class="form-group">
									<select name="pageTypeIds" class="selectpicker show-tick form-control" multiple data-live-search="true" id="pageTypeId" title="请选择">
									</select>
								</div>
								</td>
							</tr>
...
<script type="text/javascript" src="${path}/static/js/basic/mrexporttypeform.js"></script>
</html>