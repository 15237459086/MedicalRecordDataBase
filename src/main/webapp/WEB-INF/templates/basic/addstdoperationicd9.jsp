	...
	<div style="width:100%;height:80%;">
			...
			<div style="width:100%;height:510px;">
				<div id="list_NR" style="float:left">
					<div class="loc">
						<h3>新增北京版RC022-ICD-9手术编码信息</h3>
					</div>
					<input type="hidden" id="path" value="${path}"/>
					<form class="navbar-form" action="${path}/operationIcd9/insertStdOperationIcd9" method="post" style="width:100%">
					  ...
					  <tr>
							<td>备注</td>
								<td colspan="3">
								<div class="form-group">
									<textarea rows="5" cols="40" class="form-control" name="comment"></textarea>
								</div>
							</td>
						</tr>
