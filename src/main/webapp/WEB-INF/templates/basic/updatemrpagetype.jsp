	...
	<div style="width:100%;height:80%;">
			...
			<div style="width:100%;height:510px;">
				<div id="list_NR" style="float:left">
					...
					<form class="form-horizontal" action="${path}/basic/updateMrPageType" method="post" >
						<input type="hidden" name="status" value="${basic.status }" />
						<input type="hidden" id="basicId" name="pageTypeId" value="${basic.pageTypeId}"/>
						<table style="margin-top:5px;text-align: center">
							...
							<td width="90px">排序:</td>
								<td>
								<div class="form-group">
										<input type="text" name="sortCode" class="form-control" value="${basic.sortCode}"/>
									</div>
									</td>
							</tr>
							<tr>
