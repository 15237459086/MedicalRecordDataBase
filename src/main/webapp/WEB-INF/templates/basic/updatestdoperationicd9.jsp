	...
	<div style="width:100%;height:80%;">
			...
			<div style="width:100%;height:510px;">
				<div id="list_NR" style="float:left">
					...
					<form class="navbar-form" action="${path}/operationIcd9/updateStdOperationIcd9" method="post" style="width:100%">
					   ...
					   <tr>
							<td>手术标识</td>
								<td>
								<div class="form-group">
									<select name="stdOperationMarkId" class="form-control" style="width:235px;"> 
										<option value="">请选择</option>
										<c:forEach var="opsMark" items="${operationMarks}">
											<option value="${opsMark.id}" <c:if test="${opsMark.id==basic.stdOperationMarkId}">selected="selected"</c:if>>${opsMark.name}</option>
										</c:forEach>
									</select>
								</div>
							</td>
						...
						<tr>
							...
							<td colspan="3">
								<div class="form-group">
									<textarea rows="5" cols="50" class="form-control" name="comment">${basic.comment}</textarea>
								</div>
							</td>
						</tr>
...
<script type="text/javascript" src="${path}/static/js/basic/stdOperationBeijingIcd9form.js"></script>
