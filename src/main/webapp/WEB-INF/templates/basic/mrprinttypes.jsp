		...
		<div style="width:100%; height: 100%;" id="content">
			<div id="list_NR" style="float: left;">
				...
				<div class="list_con_table">
					...
					<form action="${path}/basic/getMrPrinterTypes" method="get" id="queryForm">
					...
					<form action="${path}/basic/getMrPrinterTypes" method="get" id="pageForm">
...
<script type="text/javascript">
	            ...
	            success: function(data) {
	            	if (data.success==true) {   --%>
	            		 confirm("删除提示","是否删除？",function(){
	            			 $.ajax({
	 	         	            type: "POST",
	 	         	           url:"<%=path%>/basic/deleteMrPrinterType?id="+id,
	 	         	            success: function(data) {
	 	         	            	if (data.success==true) {
	   ...
	   function insertBasic(){
		   location.href="<%=basePath%>/basic/addMrPrinterTypePage";
	   }
	   ...
	   function updateBasic(id){
		   ...
		   location.href = "<%=basePath%>/basic/showMrPrinterType?id="+id+"&currentPage="+currentPageCount+"&pageSize="+pageCount+"&name="+queryName+"&hospitalId="+hospitalId;
	   }
	</script>
</html>