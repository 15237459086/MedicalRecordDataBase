		...
		<div style="width:100%; height: 100%;">
			<div id="list_NR" style="float: left;">
				...
				<div class="list_con_table">
					...
					<form action="${path}/basic/getStdOperations" method="get" id="queryForm">
					...
					<form action="${path}/basic/getStdOperations" method="get" id="pageForm">
				...
				<button class="button" onclick='insertBasic()' style="float:right;">新增</button>
				 <table class="tableList" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class="tdLabel_4" style="width:35%;">名称</td>
						<td class="tdLabel_4" style="width:35%;">英文名</td>
...
<script type="text/javascript">
	   ...
	   function deleteBasic(code){
	            		 ...
	            		 confirm("删除提示","是否删除？",function(){
	            			 $.ajax({
	 	         	            type: "POST",
	 	         	           url:"<%=path%>/basic/deleteStdOperation?code="+code,
	 	         	            success: function(data) {
	 	         	            	if (data.success==true) {
	 	         	            		location.href="<%=basePath%>/basic/getStdOperations";
	 	         	    			} else {
	   ...
	   function insertBasic(){
		   location.href="<%=basePath%>/basic/addStdOperationPage";
	   }
	   ...
	   function updateBasic(code){
		   ...
		   location.href = "<%=basePath%>/basic/showStdOperation?code="+code+"&currentPage="+currentPageCount
