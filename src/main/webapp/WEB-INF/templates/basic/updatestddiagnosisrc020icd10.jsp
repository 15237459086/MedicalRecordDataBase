	...
	<div style="width:100%;height:80%;">
			...
			<div style="width:100%;height:510px;">
				<div id="list_NR" style="float:left">
					...
					<form class="navbar-form" action="${path}/diagnosis/updateStdDiagnosisRc020Icd" method="post" style="width:100%">
...
<script type="text/javascript" src="${path}/static/js/basic/diagnosisRcIcd10form.js"></script>
