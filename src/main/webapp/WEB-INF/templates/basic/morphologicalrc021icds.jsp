	...
	<div style="width: 100%; height:100%;">
		...
		<div style="width:100%; height: 100%;">
			<div id="list_NR" style="float: left;">
				<div class="loc">
					<h3>全国版RC021-ICD-10形态学编码管理</h3>
				</div>

				<div class="list_con_table">
					<input type="hidden" value="${basicDataQuery.totalCounts}" id="totalCountsHidden">
					<form action="${path}/morphological/getMorphologicalRc021Icds" method="get" id="queryForm">
					...
					<form action="${path}/morphological/getMorphologicalRc021Icds" method="get" id="pageForm">
				...
				<button class="button" onclick='insertBasic()' style="float:right;">新增</button>
				 <table class="tableList" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class="tdLabel_4" style="width:80%">名称</td>
...
<script type="text/javascript">
	   function deleteBasic(code){
	            		 confirm("删除提示","是否删除？",function(){
	            			 $.ajax({
	 	         	            type: "POST",
	 	         	           url:"<%=path%>/morphological/deleteMorphologicalRc021Icd?code="+code,
	 	         	            success: function(data) {
	 	         	            	if (data.success==true) {
	 	         	            		location.href="<%=basePath%>/morphological/getMorphologicalRc021Icds";
	 	         	    			} else {
	   ...
	   function insertBasic(){
		   location.href="<%=basePath%>/morphological/addMorphologicalRc021IcdPage";
	   }
	   ...
	   function updateBasic(code){
		   ...
		   location.href = "<%=basePath%>/morphological/showMorphologicalRc021Icd?code="+code+"&currentPage="+currentPageCount
