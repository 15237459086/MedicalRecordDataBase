	...
	<div style="width:100%;height:80%;">
			...
			<div style="width:100%;height:510px;">
				<div id="list_NR" style="float:left">
					...
					<form class="form-horizontal" action="${path}/basic/updateMedicalOffice" method="post" style="width:100%;padding:0">
						<input type="hidden" name="status" value="${basic.status }" />
						<input type="hidden" id="basicId" name="id" value="${basic.id}"/>
...
<script type="text/javascript" src="${path}/static/js/basic/medicalofficeform.js"></script>
